...
(define (scheme-implementation-type) 'MonaScheme)
...
(define (scheme-implementation-version) "0.1")
...
(define library-vicinity (lambda () "/home/taro/scheme/slib/"))
;;   (let ((library-path
;; 	 (or
...
(define (home-vicinity) "/home/taro")
...
;@
(define vicinity:suffix?     (lambda (chr) (and (memv chr '(#\/)) #t)))
;;   (let ((suffi
;; 	 (case (software-type)
;; 	   ((amiga)				'(#\: #\/))
;; 	   ((macos thinkc)			'(#\:))
...
(define most-positive-fixnum 4000000)

;;@ Return argument
(define (identity x) x)

;;@ SLIB:EVAL is single argument eval using the top-level (user) environment.
(define (slib:eval s) (begin (eval s (scheme-report-environment 5))))

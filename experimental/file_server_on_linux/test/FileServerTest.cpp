...
void FileServerTest::testProcessReadDirectory()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("readdir /system/process mi != NULL", mi != NULL);
...
void FileServerTest::testProcessReadFile()
{
    ...
    CPPUNIT_ASSERT_MESSAGE("process file open", fileID == MONA_SUCCESS);

    // file read
    monapi_cmemoryinfo* mi2 = monapi_call_file_read_data2(fileID, 20);
    CPPUNIT_ASSERT_MESSAGE("read /system/process/file mi2 != NULL", mi2 != NULL);

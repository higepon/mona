 ...
 * @param  piece <code>OthelloBoard.WHITE, OthelloBoard.BLACK, OthelloBoard.EMPTY</code>
 * @return 駒の個数
 */
int OthelloBoard::countPieces(int piece) {
 ...
 * @param  x (x, y) 駒の位置
 * @param  y (x, y) 駒の位置
 * @return 駒 盤面の範囲外の場合は<code>OthelloBoard.EMPTY</code>
 */
int OthelloBoard::getPiece(int x, int y) {
 ...
 * @return 駒 盤面の範囲外の場合は<code>OthelloBoard.EMPTY</code>
 */
int OthelloBoard::getPiece(Point* point) {
    return getPiece(point->x, point->y);
}

/**
 * 現在の手番のプレイヤーを返す<code>OthelloBoard.EMPTY</code>を返したときは勝負の決着がついている状態<BR>
 * @return 現在の手番のプレイヤー <code>OthelloBoard.BLACK, WHITE, EMPTY</code>
 */
int OthelloBoard::getCurrentHand() const {
 ...
 */
bool OthelloBoard::setPiece(int x, int y, int piece) {
 ...
 */
bool OthelloBoard::existNotReversedPieces() {
 ...
 * @return 現在ターン
 */
int OthelloBoard::getTurn() const {
    return this->turn;
}
 ...
 * @return 裏返せる駒数
 */
int OthelloBoard::countReversiblePieces(int x, int y, int piece) {
 ...
 * 指定した駒を裏返す
 */
void OthelloBoard::reversePiece(int x, int y) {
 ...
 */
bool OthelloBoard::checkRange(int x, int y) {
 ...
 */
int OthelloBoard::countReversiblePieceToOneAngle(int x, int y, int toX,int toY
 ...
 * 裏返した色を返す
 */
int OthelloBoard::turnColor(int piece) {
    return piece * -1;
}
 ...
 * pieceを(x, y)に置いたときに、裏返す駒をすべて記憶
 */
bool OthelloBoard::recordReversiblePieces(int x, int y, int piece) {
...
bool OthelloBoard::isTherePlace(int piece) {

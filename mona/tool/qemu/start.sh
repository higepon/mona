...
#  -vnc :2
$QEMU $VNCFLAG -m 512 -enable-kvm -k ja -serial file:$HOME/mona-qemu.log -cdrom ../mkimg/mona.iso -fda ../mkimg/mona.img -boot d  -soundhw es1370 -net user -net nic,model=virtio -redir tcp:8080:10.0.2.15:80 -redir tcp:8007:10.0.2.15:7 -redir tcp:8181:10.0.2.15:8181 \

...
extern int syscall_mutex_trylock(intptr_t id);
extern int syscall_mutex_lock(intptr_t id);
extern int syscall_mutex_lock_timeout(intptr_t id, intptr_t timeout);
extern int syscall_mutex_unlock(intptr_t id);

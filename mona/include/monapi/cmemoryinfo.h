...
extern intptr_t monapi_cmemoryinfo_create(monapi_cmemoryinfo*, uint32_t, int, int isImmediateMap);
extern intptr_t monapi_cmemoryinfo_map(monapi_cmemoryinfo*, int isImmediateMap);

...
public:
  Render (jint, jint);
  static void SetTexture (::Texture2 *);
  static void Clear ();
...
private:
  ...
  static void DrawPerspectivePolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
  static void DrawFastPerspectivePolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
  static void ScanEdge (::TLVertex *, ::TLVertex *);
public:
  static jint GetTexelBiLiner (jint, jint);
...
public: // actually package-private
  ...
  static const jint STATE_PERSPECTIVE = 64L;
  static const jint STATE_FAST = 128L;
  static jintArray tfog;

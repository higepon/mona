...
private:
  ...
  static void DrawShadowPolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
  static void DrawAlphaPolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
  static void ScanEdge (::TLVertex *, ::TLVertex *);
public:
  static jint GetTexel (jint, jint);
...
public: // actually package-private
  ...
  static const jint STATE_ALPHABLEND = 16L;
  static const jint STATE_SHADOW = 32L;

...
public:
  ...
  static void CreateMipMap (JArray<jintArray> *, jint, jint, jint);
  static void Clear ();
...
private:
  static void DrawFilteringPolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
  static void DrawMipPolygon (::TLVertex *, ::TLVertex *, ::TLVertex *);
...
public: // actually package-private
  ...
  static const jint STATE_MIPMAP = 16L;
  static const jint STATE_LINER = 32L;
  static const jint MAX_MIPLEVEL = 5L;
  static jint lv1;
  static jint lv2;
  static jint blend;

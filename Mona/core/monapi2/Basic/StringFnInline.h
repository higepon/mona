...
*/
bool StringFn::isEqual(cpchar1 cszP,cpchar1 cszQ,int iCompareCount)
{
...
/**
	...
	@date	2005/08/20	junjunn 作成
*/
bool StringFn::isEqualNoCase(cpchar1 cszP,cpchar1 cszQ,int iCompareCount)
{
...
/**
	...
	@date	2005/08/20	junjunn 作成
*/
bool StringFn::isEmpty(cpchar1 cszSource)
{
...
/**
	...
	@date	2005/08/20	junjunn 作成
*/
pchar1 StringFn::findEnd(cpchar1 pAt)
{
...
/**
	...
	@date	2005/08/20	junjunn 作成
*/
int	StringFn::join(pchar1 szOut,cpchar1 cszIn,int iCopyCount)
{
	szOut = findEnd(szOut);
...
/**
	...
	@date	2005/08/20	junjunn 作成
*/
int	StringFn::remove(pchar1 szSrc,cpchar1 cszRemove)
{

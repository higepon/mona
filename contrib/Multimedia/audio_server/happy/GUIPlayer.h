...
private:
    ...
    enum
    {
        ...
        COMMAND_EXIT,
        MSG_BUFFER_SIZE = 64,
        BACKGROUND_COLOR = monagui::Color::white, //0xff000000 | (0xff << 16) | (0xd3 << 8) | 0x21,
        BUTTON_BACKGROUND_COLOR1 = monagui::Color::lightGray,
        BUTTON_BACKGROUND_COLOR2 = monagui::Color::blue,
        BUTTON_FOREGROUND_COLOR1 = monagui::Color::black,
        BUTTON_FOREGROUND_COLOR2 = monagui::Color::white,
    };

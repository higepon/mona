...
{
/*
    //SocketContainerリスト初期化
    conSocHash = new HList<SocketContainer*>();
    
    
    //ここで、Echoサーバをリスンする。
    //TODO 本来ならEchoサーバとして実装すべし。SocketContainer層も同じく。
    //とりあえず動く物を
    
    SocketContainer *echoSoc;
    
    echoSoc = new SocketContainer();
    echoSoc->status=LISTEN;
    echoSoc->myport=7;

    //SocketContainerリストに追加
